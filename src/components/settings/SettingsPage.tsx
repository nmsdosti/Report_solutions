    ...
    <div className="fixed inset-0 bg-[#0D1B2A]/95 z-50 flex flex-col">
      <header className="bg-[#162032] border-b border-[#1E3A5F] px-6 py-4 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-white font-bold">Company Details</h1>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-4xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-5">
            <h2 className="text-[#8BA8C4] text-sm font-semibold tracking-wider">
              BRANDING DETAILS
            </h2>
            ...
            {[
              {
                key: "companyName",
                label: "COMPANY NAME",
                placeholder: "TechBal Solutions",
              },
              {
                key: "phone",
                label: "PHONE NUMBER",
                placeholder: "+91 123 456 8800",
              },
              {
                key: "email",
                label: "EMAIL ADDRESS",
            ...
            >
              <div className="p-4 border-b border-[#CBD5E1] flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs font-bold text-[#00C9A7] tracking-widest">
                    DYNAMIC BALANCING REPORT
                  </div>
                  <div className="text-[10px] text-[#4A6B8A] font-mono mt-0.5">
                    Case ID: DBR-20240101-001
                  </div>
                </div>
              </div>
                ...
                <div className="flex gap-3">
                  {["SMOOTH OPERATION", "SMOOTH RELIABILITY"].map((t) => (
                    <div key={t} className="flex items-center gap-1">
                      ...
                      <span className="text-[7px] font-bold text-[#1a1a2e]">
                        {t}
                      </span>
                    </div>
                  ))}
